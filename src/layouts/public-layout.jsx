...
const PublicLayout = () => {
  ...
  if (isLoggedIn) return <Navigate to="/homepage" />;
      ...
      <div className="text-text">
        ...
        {isLoggedIn ? (
          <div
            className={` ${
              !sidebar && window.screen.width < 768
                ? "translate-x-[-320px]"
                : "transition-x-0 "
            } transition-transform   z-[999] w-[25%] min-w-[250px] bg-text h-screen fixed overflow-y-scroll  block`}
          >
            <Sidebar
              handleSidebarVisibility={handleSidebarVisibility}
              items={items}
          ...
          <div
            ...
            } transition-transform   z-[999] bg-text h-screen w-[25%] min-w-[250px] fixed overflow-y-scroll  lg:hidden block`}
          >
            <Sidebar
              handleSidebarVisibility={handleSidebarVisibility}
              items={items}
